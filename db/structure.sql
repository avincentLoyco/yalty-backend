...
--
-- Name: employee_weekly_reports; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.employee_weekly_reports (
    id integer NOT NULL,
    employee_id uuid NOT NULL,
    ...
    bank_holidays double precision NOT NULL,
...
--
-- Name: employee_weekly_reports_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_weekly_reports_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: employee_weekly_reports_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_weekly_reports_id_seq OWNED BY public.employee_weekly_reports.id;
...
ALTER TABLE ONLY public.employee_weekly_reports ALTER COLUMN id SET DEFAULT nextval('public.employee_weekly_reports_id_seq'::regclass);
...
--
-- Name: employee_weekly_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.employee_weekly_reports
    ADD CONSTRAINT employee_weekly_reports_pkey PRIMARY KEY (id);
...
--
-- Name: index_employee_weekly_reports_on_employee_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_employee_weekly_reports_on_employee_id ON public.employee_weekly_reports USING btree (employee_id);


--
-- Name: index_employee_weekly_reports_on_year; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_employee_weekly_reports_on_year ON public.employee_weekly_reports USING btree (year);
...
--
-- Name: fk_rails_d6e4227a06; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.employee_weekly_reports
    ADD CONSTRAINT fk_rails_d6e4227a06 FOREIGN KEY (employee_id) REFERENCES public.employees(id) ON DELETE CASCADE;
...
INSERT INTO schema_migrations (version) VALUES ('20180926061519');

...
RSpec.describe 'generate:registration_key_token', type: :rake do
  ...
  let(:task_name) { 'generate_token' }
  subject { rake['generate:registration_key_token'].invoke }

...
RSpec.describe RecreateBalances::AfterEmployeeTimeOffPolicyUpdate, type: :service do
  ...
  context 'to past' do
    context 'when there are no other etops' do
      ...
      let(:expeted_balances_dates) do
        ['2013-01-15', '2013-12-31', '2014-01-01', '2014-04-01', '2014-12-31', '2015-01-01',
    ...
    context 'when there are etop before updated one' do
      ...
      context 'with additions before new etop' do
        ...
        let(:expeted_balances_dates) do
          ['2013-02-01', '2013-12-31', '2014-01-01', '2014-02-01', '2014-04-01', '2015-01-31',
           '2015-02-01', '2015-04-01', '2015-05-01', '2016-01-31', '2016-02-01', '2016-05-01',
           '2017-01-31', '2017-02-01', '2017-05-01', '2018-05-01'].map(&:to_date)
        end
      ...
      context 'without additions before new etop' do
        ...
        context 'with time off' do
          let(:balances_dates_with_time_off) do
            ['2013-02-01', '2013-06-01', '2014-01-31', '2014-02-01', '2014-04-01', '2015-01-31',
             '2015-02-01', '2015-05-01', '2015-06-01', '2016-01-31', '2016-02-01', '2016-04-01',
             '2016-05-01', '2017-01-31', '2017-02-01', '2017-05-01', '2018-05-01'].map(&:to_date)
          end
        ...
        context 'without time off' do
          let(:expeted_balances_dates) do
            ['2013-02-01', '2013-06-01', '2014-01-31', '2014-02-01', '2014-04-01', '2015-01-31',
             '2015-02-01', '2015-05-01', '2016-01-31', '2016-02-01', '2016-05-01', '2017-01-31',
      ...
      context 'when moving behind another etop' do
        ...
        let(:expeted_balances_dates) do
          ['2013-02-01', '2013-12-31', '2014-01-01', '2014-04-01', '2014-06-01', '2014-10-01',
           '2015-01-31', '2015-02-01', '2015-04-01', '2016-01-31', '2016-02-01', '2016-04-01',
           '2016-05-01', '2017-01-31', '2017-02-01', '2017-04-01', '2018-04-01'].map(&:to_date)
        end
      ...
      context 'when moving behind more than one etop' do
        ...
        let(:expeted_balances_dates) do
          ['2013-02-01', '2013-12-31', '2014-01-01', '2014-02-15', '2014-04-01', '2014-10-01',
           '2015-01-31', '2015-02-01', '2015-04-01', '2015-05-01', '2015-10-01', '2015-12-31',
           '2016-01-01', '2016-04-01', '2016-12-31', '2017-01-01', '2017-04-01', '2017-12-31',
  ...
  context 'to future' do
    context 'when there are no other etops' do
      ...
      let(:expeted_balances_dates) do
        ['2014-10-01', '2014-12-31', '2015-01-01', '2015-12-31', '2016-01-01', '2016-04-01',
         '2016-12-31', '2017-01-01', '2017-04-01', '2017-12-31', '2018-01-01', '2018-04-01',
         '2019-04-01',].map(&:to_date)
      end
    ...
    context 'with etop before moved one' do
      ...
      let(:expeted_balances_dates) do
        ['2013-02-01', '2013-12-31', '2014-01-01', '2014-04-01', '2014-12-31', '2015-01-01',
         '2015-04-01', '2015-10-01', '2016-01-31', '2016-02-01', '2016-04-01', '2017-01-31',
         '2017-02-01', '2017-04-01', '2018-04-01'].map(&:to_date)
      end
    ...
    context 'when moved etop is between other two' do
      ...
      let(:expeted_balances_dates) do
        ['2013-02-01', '2013-12-31', '2014-01-01', '2014-04-01', '2014-12-31', '2015-01-01',
         '2015-04-01', '2015-10-01', '2016-01-31', '2016-02-01', '2016-04-01', '2016-06-01',
         '2016-12-31', '2017-01-01', '2017-04-01', '2018-04-01'].map(&:to_date)
      end
    ...
    context 'moving etop after another one' do
      ...
      let(:expeted_balances_dates) do
        ['2013-02-01', '2013-12-31', '2014-01-01', '2014-04-01', '2014-12-31', '2015-01-01',
         '2015-03-01', '2015-04-01', '2015-10-01', '2016-01-31', '2016-02-01', '2016-04-01',
         '2017-01-31', '2017-02-01', '2017-04-01', '2018-04-01'].map(&:to_date)
      end

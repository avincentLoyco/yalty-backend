...
StripeCustomer = Struct.new(:id, :description, :email, :default_source, :sources, :metadata, :save)
...
StripePlan = Struct.new(:id, :amount, :currency, :interval, :name, :active, :trial_period_days)
